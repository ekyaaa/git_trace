...
void main() async {
  final templateBytes = await File('/tmp/original_template.docx').readAsBytes();
  ...
  await File('/tmp/original_roundtrip.docx').writeAsBytes(encoded!);
  print('Written /tmp/original_roundtrip.docx (${encoded.length} bytes)');
}
